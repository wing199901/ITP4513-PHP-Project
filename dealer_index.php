...
<body class="font">
  ...
  <br>
  <ul>
    <li><a class="active" href="dealer_index.php">Home</a></li>
  ...
  printf("<h1 style='text-align: center;font-size: 50px;margin-top:200px;color: grey;'>Welcome %s</h1>",$rc['name']);//welcome message
